...
for j in range (variation_number):
    ...
    if show_result:
        ...
        plt.title("x vs time")
        plt.grid(True)
        plt.savefig(plot_folder_path + scenario + " x vs time.svg", format='svg', transparent=True)
        plt.savefig(plot_folder_path + scenario + " x vs time.png")

        plt.figure(scenario + " l vs time")
        ...
        plt.title("l vs time")
        plt.grid(True)
        plt.savefig(plot_folder_path + scenario + " l vs time.svg", format='svg', transparent=True)
        plt.savefig(plot_folder_path + scenario + " l vs time.png")

        plt.figure(scenario + " theta vs time")
        ...
        plt.grid(True)
        plt.savefig(plot_folder_path + scenario + " theta vs time.svg", format='svg', transparent=True)
        plt.savefig(plot_folder_path + scenario + " theta vs time.png")

        plt.figure(scenario + " u1 vs time")
        ...
        plt.grid(True)
        plt.savefig(plot_folder_path + scenario + " u1 vs time.svg", format='svg', transparent=True)
        plt.savefig(plot_folder_path + scenario + " u1 vs time.png")

        plt.figure(scenario + " u2 vs time")
        ...
        plt.grid(True)
        plt.savefig(plot_folder_path + scenario + " u2 vs time.svg", format='svg', transparent=True)
        plt.savefig(plot_folder_path + scenario + " u2 vs time.png")

        plt.figure(scenario + " state vs time")
        plt.plot(time, x, "r", label="x (m)")
        plt.plot(time, l, "b", label="l (m)")
        plt.plot(time, theta, "g", label="theta (degree)")
        plt.legend(loc="upper right")
        ...
        plt.grid(True)
        plt.savefig(plot_folder_path + scenario + " state vs time.svg", format='svg', transparent=True)
        plt.savefig(plot_folder_path + scenario + " state vs time.png")

    # plt.show()

df = pd.DataFrame(result)
df.to_excel("Simulasi/Simulasi Gantry Motor/result.xlsx", index=False)
